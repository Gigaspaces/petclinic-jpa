...
import org.springframework.samples.petclinic.util.DummyDataCreator;
...
public class ClinicController {
	...
	@Autowired
	public ClinicController(Clinic clinic, DummyDataCreator dummyDataCreator) {
		this.clinic = clinic;
        this.dummyDataCreator = dummyDataCreator;
	}
    ...
    @RequestMapping(value = "/createDummyData", method = RequestMethod.GET)
    public ModelAndView createDummyData() {
        dummyDataCreator.createDummyData();
        ModelAndView mav = new ModelAndView("welcome");
        mav.addObject("dummyDataCreated", Boolean.TRUE);
        return mav;
    }
